...
#
DROP TABLE IF EXISTS QRTZ2_FIRED_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_PAUSED_TRIGGER_GRPS;
DROP TABLE IF EXISTS QRTZ2_SCHEDULER_STATE;
DROP TABLE IF EXISTS QRTZ2_LOCKS;
DROP TABLE IF EXISTS QRTZ2_SIMPLE_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_SIMPROP_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_CRON_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_BLOB_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_TRIGGERS;
DROP TABLE IF EXISTS QRTZ2_JOB_DETAILS;
DROP TABLE IF EXISTS QRTZ2_CALENDARS;
